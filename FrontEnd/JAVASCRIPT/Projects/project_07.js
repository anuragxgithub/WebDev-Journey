...
form.addEventListener('submit', (e)=> {
    ...
    const output = `Hi! ${name} ${surname}, Your Zodiac sign is: ${zodiacSigns[month-1]}. ${compliments[day-1]}
    ${victimCardCompliments[year%20]} ${recommendations[(day*month)%30]} ${predictions[(name.length*surname.length)%20]}`;
