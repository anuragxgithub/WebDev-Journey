...
// filter the products which are in stock and bolongs to the electronics category
const newArray = products.filter((product) => product.inStock  && product.category === "Electronics")
console.log(newArray);

console.log("--------------------------------------------------");
// sort the products which are priced above 100 in ascending order of price
const newArray2 = products.filter((product) => product.price > 100).sort((a,b) => a.price - b.price)
console.log(newArray2);


// using map create an array of products with name and price only
console.log("--------------------------------------------------");
const newArray3 = products.map((product) => ({name: product.name, price: product.price})) // note: put the curly braces in parentheses otherwise error or will treat it as function
console.log(newArray3);

console.log("--------------------------------------------------");
// chaining
const newArr = products.filter((product) => product.price > 100).sort((a,b) => a.price - b.price).map((product) => ({name: product.name, price: product.price}))
console.log(newArr);